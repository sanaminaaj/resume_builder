...
document.getElementById('contact2').style.color=color;
document.getElementById('language2').style.color=color;
...
document.getElementById('interest2').style.color=color;
...
document.getElementById('projects2').style.color=color;
document.getElementById('ed2').style.color=color;
document.getElementById('certifications2').style.color=color;
document.getElementById('languages2').style.color=color;
document.getElementById('internships2').style.color=color;
document.getElementById('main').style.backgroundColor=color;
document.getElementById('interests2').style.color=color;
